...
int main(void) {
    ...
    //180 Degree Scan
        ...
        for (objectListIdx = 0; objectListIdx < objectCount; objectListIdx++)
        {
            ...
            timer_waitMillis(500);
            objectList[objectListIdx].distance = scanPING(objectList[objectListIdx].middlePoint); //use sonar sensor to find the distance
            timer_waitMillis(500);
        ...
        servo_move(objectList[smallestWidthIdx].middlePoint); //Point towards the smallest width object
